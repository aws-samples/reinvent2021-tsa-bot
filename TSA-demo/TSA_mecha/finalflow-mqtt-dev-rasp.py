...
from servo_actions import initialAvaIntroServo, myNameisAvaServo, Avadoyouhavequestion, checkAgentontheright, avagoodbye

import threading


sys.path.append('/home/pi/TSA/TSA-demo/TSA_voice_assistant/')
from raspberry_voice_assistant import synthesize_speech, call_lexv2, decode, get_voiceid, record_phrase, play_audio, set_color, color_start, translatelang

sys.path.append('/home/pi/TSA/TSA-demo/TSA_rekognition/')
...
sys.path.append('/home/pi/TSA/TSA-demo/TSA_flight_status/')
                ...
                if 20 <= distance <= 180:
                    ...
                    try:
                        ...
                        if base64_message == 'Let me identify your items.' or base64_message == 'Permítanme identificar sus artículos.':
                            if langcode == 'es_US':
                                mqtt_publish('{"message": "Déjame identificar tus artículos", "presence": "request" }')
                            else:
